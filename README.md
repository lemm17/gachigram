...
* 16.11.19 - реализована лента
* 23.11.19 - реализованы возможности комментирования, (диз)лайканья
* 30.11.19 - реализованы список уведомлений, список подписок/подписчиков, API
